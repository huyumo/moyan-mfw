...
| 分类 | 目录 | 说明 | 负责人 |
|------|------|------|--------|
| 核心文档 | `docs/core/` | 核心概念、架构设计 | @tech-lead |
| 流程文档 | `docs/flows/` | 业务流程、操作指南 | @product |
| 页面文档 | `docs/pages/` | 页面设计、交互说明 | @ui |
| API 文档 | `docs/api/` | 接口定义、错误码 | @backend |
| 数据库文档 | `docs/database/` | 数据库设计、ER 图 | @backend |
| 追踪文档 | `docs/tracking/` | 问题追踪、变更记录 | @doc |
| 团队文档 | `docs/team/` | 团队协作、角色定义、会议纪要 | @doc |
