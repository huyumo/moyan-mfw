...
| 权限 ID | 权限名称 | 操作权限 (pcAction) |
|---------|----------|---------------------|
| P001 | 考勤管理 | 查看 (view) |
| P002 | 请假申请 | 创建 (create)、查看 (view) |
| P003 | 公告查看 | 查看 (view) |
...
| 权限模块 | 权限项 | 操作 (pcAction) |
|----------|--------|-----------------|
| 任务管理 | 任务列表 | 查看 (view) |
| 任务管理 | 任务详情 | 查看 (view)、评论 (comment) |
| 任务管理 | 我的任务 | 查看 (view)、更新状态 (update_status) |
| 代码管理 | 代码仓库 | 查看 (view)、提交 (commit) |
| 文档管理 | 项目文档 | 查看 (view)、编辑 (edit) |
...
- [权限分配流程](../flows/permission-assignment.md) - 权限分配详细流程
- [角色管理页面](../pages/role-management.md) - 角色管理操作说明
- [成员管理页面](../pages/member-management.md) - 成员管理操作说明
- [审计日志设计](../api/audit-log-design.md) - 审计日志记录规范
