...
>
> **相关页面**: [应用类型管理页面](../05-页面设计/应用类型管理页面.md)
>
> **数据结构**: [AppTypeEntity](../03-数据库设计/数据库实体设计.md#11-apptypeentity-应用类型实体), [RoleEntity](../03-数据库设计/数据库实体设计.md#13-roleentity-角色实体), [PermissionEntity](../03-数据库设计/数据库实体设计.md#14-permissionentity-权限实体)
>
...
async function test_concurrentPoolShrinkAndRoleAssign() {
  ...
  const assignRole = assignRolePermission(roleId, {
    pcTree: [{ permissionId: 'p1', checked: true, permissionValue: 7n }]  // 包含 DELETE
  })
