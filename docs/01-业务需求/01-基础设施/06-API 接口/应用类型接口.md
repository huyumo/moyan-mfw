...
>
> **相关页面**: [应用类型管理页面](../页面/应用类型管理页面.md)
>
> **数据结构**: [AppTypeEntity](../数据库/数据库实体设计.md#11-apptypeentity-应用类型实体), [RoleEntity](../数据库/数据库实体设计.md#13-roleentity-角色实体), [PermissionEntity](../数据库/数据库实体设计.md#14-permissionentity-权限实体)
>
