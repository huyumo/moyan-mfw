...
> **相关页面**: [角色管理页面](../05-页面设计/角色管理页面.md)
>
> **数据结构**: [RoleEntity](../03-数据库设计/数据库实体设计.md#13-roleentity-角色实体), [PermissionEntity](../03-数据库设计/数据库实体设计.md#14-permissionentity-权限实体)
...
**PermissionTreeNode 结构**: 见 [统一类型定义#权限树相关](./统一类型定义.md#权限树相关)
...
interface PermissionTreePayload {
  permissionId: string;
  checked: boolean;                        // true=分配，false=移除（统一字段）
