...
| 文档 | 说明 | 阅读时间 |
|------|------|----------|
| [权限系统](./核心概念/权限系统.md) | permissionValue 数据流、权限池、验证逻辑 | 5min |
| [角色体系](./核心概念/角色体系.md) | 内置角色、应用级角色、拥有者机制 | 5min |
| [系统架构](./核心概念/系统架构.md) | 应用类型中心模式、五层架构 | 5min |
...
| 文档 | 说明 | 阅读时间 |
|------|------|----------|
| [实体设计](./数据库/数据库实体设计.md) | 表结构定义、字段说明 | 10min |
| [ER 关系图](./数据库/数据库 ER 关系图.md) | 实体关系可视化 | 5min |

### 业务流程（优先级：中）

| 文档 | 说明 | 阅读时间 |
|------|------|----------|
| [权限分配流程](./流程/权限分配流程.md) | 角色权限分配详细流程 | 10min |
| [权限池配置流程](./流程/权限池配置流程.md) | 应用类型权限池配置 | 8min |
| [系统初始化流程](./流程/系统初始化流程.md) | 系统启动时初始化逻辑 | 5min |
| [用户登录流程](./流程/用户登录流程.md) | 用户登录、应用实例选择与权限加载 | 5min |

### 页面设计（优先级：中）

| 文档 | 说明 | 阅读时间 |
|------|------|----------|
| [应用类型管理](./页面/应用类型管理页面.md) | 应用类型 CRUD 页面 | 8min |
| [应用管理](./页面/应用实例管理页面.md) | 应用实例管理页面 | 8min |
| [角色管理](./页面/角色管理页面.md) | 角色配置与权限分配 | 10min |

### 追踪文档（按需查阅）

| 文档 | 说明 |
|------|------|
| [问题追踪](./追踪/问题追踪.md) | 文档审查发现的问题与解决状态 |
| [变更日志](./追踪/变更日志.md) | 文档修改历史记录 |
...
- 问题追踪：[tracking/REVIEW-ISSUES.md](./追踪/问题追踪.md)
- 变更日志：[tracking/CHANGELOG.md](./追踪/变更日志.md)
