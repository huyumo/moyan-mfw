...
- [权限分配详细流程](../04-业务流程/权限分配流程.md) - 完整的权限分配序列图
- [数据库实体设计](../03-数据库设计/数据库实体设计.md) - 表结构定义
- [ER 关系图](../03-数据库设计/数据库 ER 关系图.md) - 实体关系可视化
...
*本文档是核心概念模块的一部分，建议按顺序阅读：[permissions.md](./权限系统.md) → [roles.md](./角色体系.md) → [architecture.md](./系统架构.md)*
