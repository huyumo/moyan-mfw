...
| 错误码定义 | 通用错误码和各模块特有错误码 | [./error-codes.md](./error-codes.md) |
...
| 实体 | 说明 | 路径 |
|------|------|------|
| AppTypeEntity | 应用类型实体 | [../数据库/数据库实体设计.md#11-apptypeentity-应用类型实体](../数据库/数据库实体设计.md#11-apptypeentity-应用类型实体) |
| AppEntity | 应用实例实体 | [../数据库/数据库实体设计.md#12-appentity-应用实例实体](../数据库/数据库实体设计.md#12-appentity-应用实例实体) |
| RoleEntity | 角色实体 | [../数据库/数据库实体设计.md#13-roleentity-角色实体](../数据库/数据库实体设计.md#13-roleentity-角色实体) |
| PermissionEntity | 权限实体 | [../数据库/数据库实体设计.md#14-permissionentity-权限实体](../数据库/数据库实体设计.md#14-permissionentity-权限实体) |
| UserEntity | 用户实体 | [../数据库/数据库实体设计.md#15-userentity-用户实体](../数据库/数据库实体设计.md#15-userentity-用户实体) |
