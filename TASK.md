...
#### Task 2 遗留: 应用类型选择器（本次完成）✅
- [x] 普通权限页面添加应用类型选择器
- [x] PC 权限页面添加应用类型选择器
- [x] 后端: 权限查询接口添加 appTypeId 参数
- [x] 后端提交: `f7ab00c`
- [x] 前端: 重新生成 apis
- [x] 前端提交: `6455148`
- [x] 前端页面集成
...
#### 组件库文档（P2）✅
- [x] MfwFormat 组件 API 文档
- [x] MfwPopup 组件 API 文档
- [x] MfwUpload 组件 API 文档
- [x] 组件库索引 README
- [x] 提交: `c3eef58`
...
| f7ab00c | 权限查询接口添加 appTypeId 参数 |
| 6455148 | 重新生成权限查询接口 API 代码 |
| 4cba8e3 | 应用类型选择器集成到权限管理页面 |
| c3eef58 | 组件库 API 文档 |
...
| 时间 | 变更类型 | 变更内容 | 原因 |
|------|----------|----------|------|
| 2026-04-03 17:30 | 完成文档 | 组件库 API 文档编写完成 | P2 任务完成 |
