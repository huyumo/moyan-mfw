...
export default defineConfig({
  ...
  vite: {
    plugins: [
      {
        name: 'mermaid-vite-plugin',
        transform(code, id) {
          if (id.includes('vitepress/dist/client/app/index.js')) {
            const importStatement = "import Mermaid from 'vitepress-plugin-mermaid/Mermaid.vue';\n"
            const componentRegistration = '\napp.component("Mermaid", Mermaid);\n'
            return importStatement + code.replace('app.component', componentRegistration + 'app.component')
          }
        }
      }
    ]
