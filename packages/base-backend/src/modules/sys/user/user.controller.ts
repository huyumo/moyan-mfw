...
export class UserController {
  ...
  @RequirePermission({ permCode: 'system:user', permissionValue: 1n }) // ADD
  ...
  @RequirePermission({ permCode: 'system:user', permissionValue: 32n }) // VIEW
  ...
  @RequirePermission({ permCode: 'system:user', permissionValue: 2n }) // EDIT
  async update(
  ...
  @RequirePermission({ permCode: 'system:user', permissionValue: 4n }) // DELETE
