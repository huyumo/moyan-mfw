...
export class RoleController {
  ...
  @RequirePermission({ permCode: 'system:role', permissionValue: 1n }) // ADD
  ...
  @RequirePermission({ permCode: 'system:role', permissionValue: 32n }) // VIEW
  ...
  @RequirePermission({ permCode: 'system:role', permissionValue: 2n }) // EDIT
  async update(
  ...
  @RequirePermission({ permCode: 'system:role', permissionValue: 4n }) // DELETE
