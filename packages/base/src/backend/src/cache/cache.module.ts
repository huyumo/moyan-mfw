...
export const CACHE_SERVICE = Symbol.for('MOYAN:MFW:CACHE_SERVICE');
export const REDIS_ONLY_SERVICE = Symbol.for('MOYAN:MFW:REDIS_ONLY_SERVICE');
/** Redis 连接配置注入 token */
export const REDIS_CONFIG = Symbol.for('MOYAN:MFW:REDIS_CONFIG');
