...
// 所有实体数组
const entities = [User, Role, UserRole, Permission, RolePermission, AppType, AppTypePermissionEntity, App, AppMember, AuditLog, PermissionValue, RouteSyncState];
  ...
  async onModuleInit() {
    ...
    this.healthCheckInterval = setInterval(async () => {
      try {
        ...
        console.error('[DatabaseHealth] Connection health check failed:', error);
