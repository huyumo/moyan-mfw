 ...
 * ```
 */
export declare function executeRawSql<T = any>(entityManager: EntityManager | DataSource, sql: string, params: Record<string, any>, printSql?: boolean): Promise<T[]>;
/**
 * WHERE 条件构建器
...
export declare class WhereBuilder {
     ...
     */
    eq(field: string, value?: any, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加不等于条件
     * @param field - 字段名
     * @param value - 值
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    neq(field: string, value?: any, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加大于条件
     * @param field - 字段名
     * @param value - 值
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    gt(field: string, value?: any, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加大于等于条件
     * @param field - 字段名
     * @param value - 值
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    gte(field: string, value?: any, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加小于条件
     * @param field - 字段名
     * @param value - 值
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    lt(field: string, value?: any, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加小于等于条件
     * @param field - 字段名
     * @param value - 值
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    lte(field: string, value?: any, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加 LIKE 条件（包含）
     * @param field - 字段名
     * @param value - 值
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    like(field: string, value?: string, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加 LIKE 条件（左匹配）
     * @param field - 字段名
     * @param value - 值
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    likeLeft(field: string, value?: string, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加 LIKE 条件（右匹配）
     * @param field - 字段名
     * @param value - 值
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    likeRight(field: string, value?: string, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加 IN 条件
     * @param field - 字段名
     * @param values - 值数组
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    in(field: string, values?: any[], logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加 NOT IN 条件
     * @param field - 字段名
     * @param values - 值数组
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    notIn(field: string, values?: any[], logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加 BETWEEN 条件
     * @param field - 字段名
     * @param min - 最小值
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    between(field: string, min: any, max: any, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加 IS NULL 条件
     * @param field - 字段名
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    isNull(field: string, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加 IS NOT NULL 条件
     * @param field - 字段名
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    isNotNull(field: string, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加自定义条件
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    custom(condition: string, params?: Record<string, any>, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 添加 AND 条件
     * @param field - 字段名
     * @param operator - 操作符
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    group(builder: WhereBuilder, logicalOperator?: 'AND' | 'OR'): this;
    /**
     * 构建 WHERE 子句和参数
