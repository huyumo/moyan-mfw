 ...
 * ```
 */
async function executeRawSql(entityManager, sql, params, printSql = false) {
...
class WhereBuilder {
     ...
     */
    eq(field, value, logicalOperator = 'AND') {
        if (value === undefined) {
            return this;
        }
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    neq(field, value, logicalOperator = 'AND') {
        if (value === undefined) {
            return this;
        }
        return this.addCondition(field, '!=', value, logicalOperator);
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    gt(field, value, logicalOperator = 'AND') {
        if (value === undefined) {
            return this;
        }
        return this.addCondition(field, '>', value, logicalOperator);
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    gte(field, value, logicalOperator = 'AND') {
        if (value === undefined) {
            return this;
        }
        return this.addCondition(field, '>=', value, logicalOperator);
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    lt(field, value, logicalOperator = 'AND') {
        if (value === undefined) {
            return this;
        }
        return this.addCondition(field, '<', value, logicalOperator);
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    lte(field, value, logicalOperator = 'AND') {
        if (value === undefined) {
            return this;
        }
        return this.addCondition(field, '<=', value, logicalOperator);
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    likeLeft(field, value, logicalOperator = 'AND') {
        if (value === undefined) {
            return this;
        }
        return this.addCondition(field, 'LIKE', `${value}%`, logicalOperator);
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    likeRight(field, value, logicalOperator = 'AND') {
        if (value === undefined) {
            return this;
        }
        return this.addCondition(field, 'LIKE', `%${value}`, logicalOperator);
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    between(field, min, max, logicalOperator = 'AND') {
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    custom(condition, params = {}, logicalOperator = 'AND') {
        this.conditions.push(`${logicalOperator} ${condition}`);
     ...
     * @param logicalOperator - 逻辑连接符（AND/OR）
     */
    group(builder, logicalOperator = 'AND') {
        const { where, params } = builder.build();
        if (where) {
     ...
     */
    addCondition(field, operator, value, logicalOperator) {
        const paramName = this.generateParamName(field);
        this.params[paramName] = value;
