...
exports.REQUIRE_PERMISSION = void 0;
exports.RequirePermission = RequirePermission;
exports.createBusinessPermissionDecorator = createBusinessPermissionDecorator;
 ...
 */
function accumulateMetadata(metadataTarget, options) {
    const existing = Reflect.getMetadata(exports.REQUIRE_PERMISSION, metadataTarget) || [];
    const existingArray = Array.isArray(existing) ? existing : [existing];
    existingArray.push(options);
    Reflect.defineMetadata(exports.REQUIRE_PERMISSION, existingArray, metadataTarget);
}
function RequirePermission(optionsOrCode, permissionValue) {
 ...
 * ```
 */
function createBusinessPermissionDecorator(businessPermissions) {
    (0, permissions_1.registerPermissionValues)([...businessPermissions]);
    return function BusinessRequirePermission(permCode, permissionValue) {
        const options = {
            permCode,
