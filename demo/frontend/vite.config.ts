...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      'moyan-mfw-extension-ledger/frontend': resolve(__dirname, '../../packages/extensions/extension-ledger/src/frontend/src'),
      'moyan-mfw-extension-ledger/shared': resolve(__dirname, '../../packages/extensions/extension-ledger/src/shared/src/index.ts'),
      'moyan-mfw-extension-sms/frontend': resolve(__dirname, '../../packages/extensions/extension-sms/src/frontend/src'),
      'moyan-mfw-extension-sms/shared': resolve(__dirname, '../../packages/extensions/extension-sms/src/shared/src/index.ts'),
      'moyan-mfw-extension-scan-code/frontend': resolve(__dirname, '../../packages/extensions/extension-scan-code/src/frontend/src'),
      'moyan-mfw-extension-scan-code/shared': resolve(__dirname, '../../packages/extensions/extension-scan-code/src/shared/src/index.ts'),
